...
public class Queens {
	...
	private boolean isValid(LinkedList<Integer> state) {
		 ...
		 * 
		 * We do this by examining the "slope" of the last queen location on the stack
		 * against all the other queen positions. If the differences in x and y are
		 * equal, then the newest queen on the stack is in conflict with another queen.
		 */
